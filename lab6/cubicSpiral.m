       ...
       function setParms(obj,parms)
        ...
        function integrateCommands(obj)
            ...
            for i=1:obj.numSamples-1
                ...
                s = i*ds;
                f_s = s*(a+b*s) * (s-sf);
                k_s = obj.curvArray(1) + f_s; 
                theta_accum = theta_accum + k_s * ds;
                theta_s = obj.poseArray(3,1) + theta_accum;
                
                cos_accum = cos_accum + cos(theta_s) * ds;
                x_s = obj.poseArray(1,1) + cos_accum;
