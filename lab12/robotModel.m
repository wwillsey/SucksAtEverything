classdef robotModel < handle
    ...
    methods(Static = true)
        ...
        function pose = pose_addition(pose_1, pose_2, sign)
            x = pose_1(1) + sign*(pose_2(1));
            y = pose_1(2) + sign*(pose_2(2));
            th = atan2(sin(pose_1(3) + sign*pose_2(3)), cos(pose_1(3) + sign*pose_2(3)));
            pose = [x,y,th];
        end
    end
