...
bj.robot_trajectory.getVAtTime(time);
            w = obj.robot_trajectory.getwAtTime(time);
            [vl, vr] = robotModel.VwTovlvr(V, w);
        end
        function [vl, vr] = feedback_velocity(obj, time)
            [V, w] = obj.controller.linear_feedback(obj.robot_trajectory, obj.estRobot, time);
            [vl, vr] = robotModel.VwTovlvr(V, w);%UNTITLED2 Summary of this function goes here
